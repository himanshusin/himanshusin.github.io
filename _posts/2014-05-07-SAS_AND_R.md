...
image: /blog_image/b1_image.png
---

![](/blog_image/b1_image.png)
...
<p>|Tasks                                  |SAS                     | R
|:--------------------------------------|:---------------------- |:----------------------------------------
|Interactive Visualization              | SAS/GRAPH, SAS Visual Analytics   | Package <code>Shiny</code>
|Ensemble Learning / Machine Learning   | SAS Enterprise Miner   | Package <code>mlr</code>, <code>Caret</code>, <code>XGBoost</code> etc
|Text / Social Media Mining             | SAS Text Miner         | Package <code>SocialMediaLab</code>, <code>rvest</code>, <code>tf</code>, <code>SnowballC</code> etc
|Optimization and Forecasting           | SAS ETS, PROC OPTMODEL | Package <code>forecast</code>, <code>optimization</code> etc.</p>
